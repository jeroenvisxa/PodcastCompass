...
const contractABI = require("../artifacts/contracts/Podcastcompass.sol/Podcastcompass.json").abi;

program
    .name("podcastcompass-cli")
    .description("CLI tool for Podcastcompass smart contract")
    .version("1.0.0");
